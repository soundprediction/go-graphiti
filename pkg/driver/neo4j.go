...
func (m *Neo4jDriver) GetNodeNeighbors(ctx context.Context, nodeUUID, groupID string) ([]types.Neighbor, error) {
	query := `
...
func (m *Neo4jDriver) parseNeighborsFromRecords(result interface{}) ([]types.Neighbor, error) {
